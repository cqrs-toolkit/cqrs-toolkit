...
- [`schema-to-ts-codegen.md`](schema-to-ts-codegen.md) — resolved 2026-05-25; codified in [ADR-0003](../decisions/0003-codegen-id-references.md). Kept on file for the original library-evaluation checklist (Q1–Q8) and the rejected empirical-check approach.
