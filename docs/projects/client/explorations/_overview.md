...
- [`locale-aware-sort.md`](locale-aware-sort.md) — graduated 2026-05-22 to [`0016-custom-collations.md`](../intent/requirements/0016-custom-collations.md) + [ADR-0010](../decisions/0010-custom-collations-design.md); file now tracks the deferred items (per-query overrides, devtools cooperation, comparator benchmarking, runtime fingerprint check).
