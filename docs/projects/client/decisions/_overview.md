...
- [ADR 0010 — Consumer-registered JS comparators for custom SQLite collations](0010-custom-collations-design.md) — _Accepted 2026-05-22_ — JS comparators registered per-connection via `sqlite3_create_collation_v2`; rejected ICU extension, ASCII sort keys, server-driven sort. Pairs with [`0016 §16`](../intent/requirements/0016-custom-collations.md).
