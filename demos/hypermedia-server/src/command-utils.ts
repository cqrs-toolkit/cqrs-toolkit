...
// ---------------------------------------------------------------------------
// Shared command response schema for apidoc documentation
// ---------------------------------------------------------------------------

const serializedEventSchema: JSONSchema7 = {
  type: 'object',
  properties: {
  ...
  required: ['streamId', 'id', 'revision', 'position', 'type', 'data', 'metadata', 'created'],
}
...
export const commandSuccessResponseSchema = {
  ...
  properties: {
    ...
    events: { type: 'array', items: serializedEventSchema },
  },
  required: ['id', 'nextExpectedRevision', 'events'],
