...
import {
  createCqrsConfig,
  type AppCommand,
} from '@cqrs-toolkit/hypermedia-base/bootstrap/cqrs-config'
...
export async function initializeClient(): Promise<CqrsClient<ServiceLink, AppCommand>> {
  const cqrsConfig = createCqrsConfig(location.origin)
