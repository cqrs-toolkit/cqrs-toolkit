/**
 * Note collection query — dispatches to versioned resolvers via ProfileHandler.
 */
...
import { GetNotesV1_0_0 } from './v1_0_0/GetNotes.js'
import { NoteRepV1_0_0 } from './v1_0_0/representation.js'

export namespace GetNotes {
  const profileHandler = new ProfileHandler<true, NoteRepository, void>({
    representations: [
      {
        version: NoteRepV1_0_0.version,
        urn: NoteRepV1_0_0.collection.profile,
        resolve: (request, reply, noteRepo) => {
          return GetNotesV1_0_0.resolve(request, reply, noteRepo)
        },
      },
    ],
  })
   ...
   */
  export const schema = GetNotesV1_0_0.schema
