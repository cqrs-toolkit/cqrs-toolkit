...
The storage layer uses a tiered worker model: SharedWorker for multi-tab support, Dedicated Worker for single-tab isolation, or main-thread execution as a fallback.

## Sections

| #   | Section                                                    | Description                                                                                                                                             |
| --- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | [Modes and Constraints](sections/modes_and_constraints.md) | Execution modes (online-only, SharedWorker, Dedicated Worker, main-thread), session model, event persistence semantics, and cross-component invariants. |
