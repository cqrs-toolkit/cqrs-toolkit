...
| #   | Section                                                    | Description                                                                                                                                       |
| --- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | [Modes and Constraints](sections/modes_and_constraints.md) | Execution modes (online-only, SharedWorker, Dedicated Worker), session model, event persistence semantics, and cross-component invariants.        |
