...
[@cqrs-toolkit/hypermedia](../../modules.md) / [server](../README.md) / GatewayTimeoutException
...
> **new GatewayTimeoutException**(`message?`, `details?`): `GatewayTimeoutException`

#### Parameters

##### message?

`string` = `'Upstream timeout'`
