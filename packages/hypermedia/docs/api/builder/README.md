...
[@cqrs-toolkit/hypermedia](../modules.md) / builder
...
- [HydraPropertyDocumentation](interfaces/HydraPropertyDocumentation.md)
- [OpenApiBuildOptions](interfaces/OpenApiBuildOptions.md)
- [OpenApiBuildResult](interfaces/OpenApiBuildResult.md)
- [OpenApiDocumentation](interfaces/OpenApiDocumentation.md)
...
- [builtinPropertyDictionary](variables/builtinPropertyDictionary.md)
...
- [docs](functions/docs.md)
- [generateHydraDocumentation](functions/generateHydraDocumentation.md)
- [loadMetaBundle](functions/loadMetaBundle.md)
- [loadSchemaBundle](functions/loadSchemaBundle.md)
- [resolveConfig](functions/resolveConfig.md)
- [resolveOpenApiUrns](functions/resolveOpenApiUrns.md)
- [urnToVocabUrl](functions/urnToVocabUrl.md)
- [writeSchemaBundle](functions/writeSchemaBundle.md)
