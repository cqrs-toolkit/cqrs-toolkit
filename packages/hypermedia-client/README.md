...
- [ADR-0003 — codegen pipeline + idReferences design](../../docs/projects/hypermedia-client/decisions/0003-codegen-id-references.md) for the full rationale.
- [Schema → TS codegen exploration](../../docs/projects/hypermedia-client/explorations/schema-to-ts-codegen.md) for the original design narrative and the library-evaluation checklist used during implementation.
- [Project castle](../../docs/projects/hypermedia-client/_overview.md) for hypermedia-client's full landscape (intent, decisions, evolution).
